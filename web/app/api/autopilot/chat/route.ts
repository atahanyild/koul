    ...
    properties: {
      ...
      rules: { type: "array", maxItems: 8, items: {
        ...
        properties: {
          ...
          action: { type: "object", additionalProperties: false, required: ["kind", "amount"], properties: { kind: { type: "string", enum: ["withdraw_to_wallet", "repay_from_wallet", "move_to_best_pool", "supply_from_wallet"] }, amount: { oneOf: [{ type: "string", enum: ["all"] }, { type: "number" }, { type: "object", additionalProperties: false, required: ["percent"], properties: { percent: { type: "integer", minimum: 1, maximum: 100 } } }] }, pool: { type: "string", enum: ["A", "B"] } } },
