          ...
          return (
            <li key={t.href}>
              <Link
                ...
                className={cn(
                  "flex min-h-16 flex-col items-center justify-center gap-1 rounded-[20px] text-[11px] font-bold transition-colors duration-[240ms] ease-out focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-lime",
